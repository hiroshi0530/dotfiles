...
#  Choices: any of ['sha384', 'blake2b', 'md5', 'sha3_224', 'sha1', 'sha3_384', 'sha512', 'sha224', 'blake2s', 'sha256', 'sha3_256', 'sha3_512']
#  Default: 'sha256'
...
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$geNTThEiKw2HbEu3w8OBPQ$Ilbe3AM3wYVyr0gmoVQanw'
